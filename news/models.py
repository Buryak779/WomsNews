...
class News(models.Model):
    """ Класс новостей
    """
    user = models.ForeignKey(User, verbose_name="Автор",on_delete=models.CASCADE) #Автор статьи
    category = models.ForeignKey(Category, verbose_name="Категория",on_delete=models.SET_NULL, null=True)
    title = models.CharField("Заголовок", max_length=100) #Заголовок статьи
    text_min = models.TextField("Мин. текст", max_length=350) #Превью статьи новостной
    text = models.TextField("Текст статьи")
    tags = models.ManyToManyField(Tag, verbose_name="Теги")
    created = models.DateTimeField("Дата создания", auto_now_add=True)#Дата создания с автодобавлением даты в поле
